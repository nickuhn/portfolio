  ...
  render: function() {
    return (
      React.createElement("main", null, 
        React.createElement("h1", null, "Pokemon Battle Royale"), 
        React.createElement(BattleFrame, null)
      )
    );
  }
});

React.render(React.createElement(App, null), document.getElementById('BattleBox'));

},{"./components/BattleFrame.jsx":4,"react":161}],2:[function(require,module,exports){
'use strict';
...
module.exports = React.createClass({displayName: "exports",
  render: function() {
    return (
      React.createElement("section", {id: "attackList"}, 
        React.createElement("button", {type: "button", onClick: this.props.lightAttack}, "Light Attack"), 
        React.createElement("button", {type: "button", onClick: this.props.heavyAttack}, "Heavy Attack"), 
        React.createElement("button", {type: "button", onClick: this.props.defend}, "Defend")
      )
    )
  }
});
...
module.exports = React.createClass({displayName: "exports",
  ...
  render: function() {
    return (
      React.createElement("section", {id: "battleField"}, 
        React.createElement("span", {id: "enemyText"}, " Wild ", this.props.enemyPokemon.name, " HP: ", this.props.enemyCurrHp, " / ", this.props.enemyPokemon.hp, " "), 
        React.createElement("img", {id: "enemyPic", src: "http://pokeapi.co" + this.props.enemySprite.image, alt: "pokemon"}), 
        React.createElement("span", {id: "userText"}, " ", this.props.userPokemon.name, " HP: ", this.props.userCurrHp, " / ", this.props.userPokemon.hp, " "), 
        React.createElement("img", {id: "userPic", src: "http://pokeapi.co" + this.props.userSprite.image, alt: "pokemon"})
      )
    )
  }
});

},{"react":161,"superagent":162}],4:[function(require,module,exports){
'use strict'
...
module.exports = React.createClass({displayName: "exports",
  ...
  render: function() {
    return (
      React.createElement("main", null, 
        React.createElement(BattleField, {enemyPokemon: this.state.enemyPokemon, 
        ...
        React.createElement(AttackList, {userAttacks: this.state.userPokemon, 
                    lightAttack: this.lightAttack, 
                    heavyAttack: this.heavyAttack, 
                    defend: this.defend}), 
        React.createElement(Printout, {userAttack: this.state.userAttack})
      )
    );
  }
});

},{"./AttackList.jsx":2,"./BattleField.jsx":3,"./Printout.jsx":5,"react":161,"superagent":162}],5:[function(require,module,exports){
'use strict';
...
module.exports = React.createClass({displayName: "exports",
  render: function() {
    var attacks = this.props.userAttack.map(function(attack) {
      return (React.createElement("p", null, attack));
    });
    return (
      React.createElement("section", {id: "printOut"}, 
        attacks
      )
    )
  }
